        ...
        if (filtered.length === 0) {
            ...
            filtered.forEach(filterItem => {
                ...
                if (filterItem.extraDetails) {
                    ...
                    const audioFiles = [
                        { keywords: ["glitter", "glitters"], file: "./audio/glitters.mp3" },
                        { keywords: ["uitvaart", "dood"], file: "./audio/death.mp3" },
                        { keywords: ["stoer", "deftig", "cool"], file: "./audio/stoer.mp3" },
                        { keywords: ["stippen", "cirkels", "rondjes"], file: "./audio/dots.mp3" },
                        { keywords: ["romantisch", "sexy"], file: "./audio/gawk.mp3" }
                    ];
                
                    audioFiles.forEach(({ keywords, file }) => {
